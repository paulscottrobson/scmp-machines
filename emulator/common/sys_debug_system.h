...
#ifdef MK14
#define WIN_TITLE 		"SC/MP MK14 Emulator"								
#endif
#ifdef WILLIAMSON
#define WIN_TITLE 		"SC/MP Ian Williamson Machine Emulator"								
#endif
...
#define DEBUG_ARGUMENTS(ac,av) CPULoadBinary(ac == 2 ? av[1]:NULL);					// Handle CLI arguments
...
#define DEBUG_RAMSTART 		(0x200)													// Initial RAM address for debugger.
...
void DBGXPattern(int x,int y,int xs,int ys,int pattern);
